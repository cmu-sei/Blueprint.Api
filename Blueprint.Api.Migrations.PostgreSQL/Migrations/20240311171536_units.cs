...
namespace Blueprint.Api.Migrations.PostgreSQL.Migrations
{
    public partial class units : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO teams(name, short_name, date_created, date_modified, created_by, modified_by, can_team_member_invite, player_team_id, can_team_leader_invite, cite_team_id, cite_team_type_id, email, gallery_team_id, msel_id, old_team_id) SELECT a.name, a.short_name, a.date_created, a.date_modified, a.created_by, a.modified_by, a.can_team_member_invite, a.player_team_id, a.can_team_leader_invite, a.cite_team_id, b.cite_team_type_id, b.email, a.gallery_team_id, b.msel_id, a.id FROM teams a JOIN msel_teams b ON a.id = b.team_id;");
