...
namespace Blueprint.Api.Migrations.PostgreSQL.Migrations
{
    ...
    [Migration("20240619192805_OrderScenarioEventsByTimeAndGroup")]
    partial class OrderScenarioEventsByTimeAndGroup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blueprint.Api.Data.Models.DataFieldEntity", b =>
                {
                    ...
                    b.HasCheckConstraint("data_field_msel_or_inject_type", "(msel_id IS NOT NULL AND inject_type_id IS NULL) OR (msel_id IS NULL AND inject_type_id IS NOT NULL)");
                });
            ...
            modelBuilder.Entity("Blueprint.Api.Data.Models.DataValueEntity", b =>
                {
                    ...
                    b.HasCheckConstraint("data_value_scenario_event_or_inject", "(scenario_event_id IS NOT NULL AND inject_id IS NULL) OR (scenario_event_id IS NULL AND inject_id IS NOT NULL)");
                });
            ...
            modelBuilder.Entity("Blueprint.Api.Data.Models.InjectEntity", b =>
                {
                    ...
                    b.Property<Guid?>("CatalogEntityId")
                        .HasColumnType("uuid")
                        .HasColumnName("catalog_entity_id");
            ...
            modelBuilder.Entity("Blueprint.Api.Data.Models.InjectEntity", b =>
                {
                    b.HasOne("Blueprint.Api.Data.Models.CatalogEntity", null)
                        .WithMany("Injects")
                        .HasForeignKey("CatalogEntityId");
