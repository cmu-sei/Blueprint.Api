...
namespace Blueprint.Api.Migrations.PostgreSQL.Migrations
{
    ...
    [Migration("20260401234914_AddCompetencyFrameworkTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blueprint.Api.Data.Models.CompetencyElementEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ElementIdentifier")
                        .HasColumnType("text")
                        .HasColumnName("element_identifier");
                    ...
                    b.HasIndex("CompetencyFrameworkId", "ElementIdentifier")
                        .IsUnique();

                    b.ToTable("competency_elements");
                });
            ...
            modelBuilder.Entity("Blueprint.Api.Data.Models.MselEntity", b =>
                {
                    ...
                    b.Property<string>("CiteScoringModelName")
                        .HasColumnType("text")
                    ...
                    b.Property<int>("GroupDisplayOrder")
                        .HasColumnType("integer")
                        .HasColumnName("group_display_order");
                    ...
                    b.Property<int>("MoveDisplayOrder")
                        .HasColumnType("integer")
                        .HasColumnName("move_display_order");
                    ...
                    b.Property<int>("TimeDisplayOrder")
                        .HasColumnType("integer")
                        .HasColumnName("time_display_order");
            ...
            modelBuilder.Entity("Blueprint.Api.Data.Models.ScenarioEventEntity", b =>
                {
                    ...
                    b.Property<Guid?>("SteamfitterTaskId")
                        .HasColumnType("uuid")
                        .HasColumnName("steamfitter_task_id");
            ...
            modelBuilder.Entity("Blueprint.Api.Data.Models.SteamfitterTaskEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Dictionary<string, string>>("ActionParameters")
            ...
            modelBuilder.Entity("Blueprint.Api.Data.Models.TeamEntity", b =>
                {
                    ...
                    b.Property<string>("CiteTeamTypeName")
                        .HasColumnType("text")
                        .HasColumnName("cite_team_type_name");
            ...
            modelBuilder.Entity("Blueprint.Api.Data.Models.XApiQueuedStatementEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Blueprint.Api.Data.Models.CompetencyElementEntity", b =>
                {
                    ...
                    b.HasOne("Blueprint.Api.Data.Models.CompetencyElementEntity", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
            ...
            modelBuilder.Entity("Blueprint.Api.Data.Models.SteamfitterTaskEntity", b =>
                {
                    b.HasOne("Blueprint.Api.Data.Models.ScenarioEventEntity", "ScenarioEvent")
                        .WithOne("SteamfitterTask")
                        .HasForeignKey("Blueprint.Api.Data.Models.SteamfitterTaskEntity", "ScenarioEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Blueprint.Api.Data.Models.CompetencyFrameworkEntity", b =>
                {
                    ...
                    b.Navigation("ProficiencyScales");
                });
